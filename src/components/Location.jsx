      ...
      {locations.map((loc, index) => (
        <div key={index} className="flex flex-col items-center w-full">
          ...
          <div className="text-center mb-8 px-4">
            {/* Optimización: Transformación acelerada por hardware para el rebote */}
            <div className="animate-bounce inline-block will-change-transform">
              <MapPin className={`${theme.accent} mb-4`} size={32} />
            </div>
          ...
          {/* Contenedor de la Tarjeta del Mapa */}
